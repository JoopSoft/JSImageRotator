    ...
    <fieldset>
        ...
        <asp:Table runat="server" BorderStyle="None" Width="100%" GridLines="Both">
            <asp:TableRow>
                ...
                </asp:TableCell></asp:TableRow></asp:Table><asp:Repeater ID="rptImageList" runat="server" OnItemDataBound="rptImages_ItemDataBound" OnItemCommand="rptImages_ItemCommand">
            <HeaderTemplate>
            </HeaderTemplate>
            <ItemTemplate>
                <asp:Table runat="server" BorderStyle="None" HorizontalAlign="Left" Width="100%" GridLines="Both">
                    <asp:TableRow>
                        ...
                        </asp:TableCell></asp:TableRow></asp:Table></ItemTemplate><FooterTemplate>
            </FooterTemplate>
        </asp:Repeater>
    </fieldset>
  </div><div>
