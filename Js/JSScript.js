    ...
    $(document).ready(function () {
        ...
        $('.JSRotator .dnnFormItem table input[type=text]')
            .each(function (idx, el) {
                ...
                if ($this.val() == '') $this.addClass('error').attr('data-id', $this.attr('id') + '_error');
                else $this.removeClass('error').removeAttr('data-id');
            ...
            .focus(function () {
                ...
                $('.JSRotator .dnnFormItem table tr.active td')
                            ...
                            if ($this.val() == '') { $this.addClass('error'); }
                                ...
                                for (var i = 0; i < $inputs.length; i++) {
                                    ...
                                    if ($('.JSRotator #' + $inputs[i]).siblings().is('error')) {
                                        if ($('.JSRotator #' + $inputs[i]).val() == '') $('.JSRotator #' + $inputs[i]).closest('tr').find('td:last .link-save').addClass('disabled');
                                        else $('.JSRotator #' + $inputs[i]).closest('tr').find('td:last .link-save').removeClass('disabled');
                                    }
        ...
        $('.JSRotator .unhidder input:checkbox')
            .each(function () {
                var $target = $(this).parent().data('target');
        ...
        $('.JSRotator .hidder-radio input:radio')
            .each(function () {
                if ($(this).is(':checked')) {
